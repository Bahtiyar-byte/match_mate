...
class MatchAppBar extends StatelessWidget {
  ...
  MatchAppBar({required this.isSearchVisible, required this.onSearchToggle});
    ...
    return Column(
      children: [
        AppBar(
          ...
          title: Text('Your MatchMates', style: TextStyle(color: theme.textTheme.bodyLarge?.color)),
          centerTitle: true,
